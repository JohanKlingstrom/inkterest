...
const Sidebar = ({ user, closeToggle }) => {
  const handleCloseSidebar = () => {
    // We are only able to toggle the sidebar if the closeToggle property exists(is passed from home)
    ...
    <div className="flex flex-col justify-between bg-white h-full overflow-y scroll min-w-210 hide-scrollbar" >
        <div className="flex flex-col" >
          ...
          <div className="flex flex-col gap-5">
            {/* the isActive property is given to us by react router dom when we use the navlink component, and is destructured below */}
            <NavLink 
              to="/" 
            ...
            <h3 className="mt-2 px-5 text-base 2xl:text-xl">Discover Styles</h3>
